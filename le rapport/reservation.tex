...
\hspace*{-0.7in}
               ...
               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=10cm]{img/reservation.png}}  
...
\hspace*{-0.7in}
               ...
               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=10cm]{img/form.png}}  
...
\hspace*{-0.7in}
               ...
               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=10cm]{img/form-select.jpeg}}  
...
\hspace*{-0.7in}
               ...
               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=10cm]{img/date-already.png}}
  ...
  sinon cela se présente comme suit
               ...
               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=10cm]{img/date-not-yet.png}}
  
  
  
  
  Maintenant, la boîte d'alerte affichera plusieurs messages en fonction des dates entrées par l'utilisateur. Pour un champ vide, le message d'alerte est le même que d'habitude. Il y a cinques messages qui peuvent apparaître :
  ...
  \vspace{0.7cm}
               ...
               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=7.5cm]{img/date-equal.png}}
  \item \textcolor{red}{les dates sont anciennes :} 
  \vspace{0.7cm}
               \hspace*{-0.7in}

               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=7.5cm]{img/date-old.png}}
  \item \textcolor{red}{la durée de la réservation est courte :} 
  \vspace{0.7cm}
               \hspace*{-0.7in}

               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=7.5cm]{img/date-inferior.png}}
  \item \textcolor{red}{la durée de la réservation est longue :} 
  \vspace{0.7cm}
               \hspace*{-0.7in}

               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=7.5cm]{img/date-superior.png}}
  \item \textcolor{red}{les dates se croisent avec une autre date :} 
  \vspace{0.7cm}
               \hspace*{-0.7in}

               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=7.5cm]{img/date-intersect.png}}
  \item \textcolor{red}{les dates sont correctes :} 
  \vspace{0.7cm}
               \hspace*{-0.7in}

               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=7.5cm]{img/date-done.png}}
...
\end{enumerate}  
  ...
  \vspace{0.7cm}
               ...
               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=7.5cm]{img/reservation-annuler.png}}
...
Maintenant, si l'administrateur s'est connecté, les pages d'accueil contiendront un autre lien au lieu de la scène de la page de contact, c'est inutile pour le cas.
  ...
  \vspace{0.7cm}
               ...
               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=9cm]{img/home-admin.png}}
  ...
  \vspace{0.7cm}
               ...
               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=11cm]{img/modify.png}}
  ...
  \vspace{0.7cm}
               ...
               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=11cm]{img/modify-add.png}}
  ...
  \vspace{0.7cm}
               ...
               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=11cm]{img/modify-remove.png}}
...
\vspace{0.7cm}
               ...
               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=8cm]{img/modify-remove-accept.png}}  
  ...
  \vspace{0.7cm}
               ...
               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=8cm]{img/modify-removed.png}}
  ...
  \vspace{0.7cm}
               ...
               \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=8cm]{img/affectation.png}}
