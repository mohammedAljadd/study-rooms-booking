...
\hspace*{-0.7in}
  ...
  Maintenant, la boîte d'alerte affichera plusieurs messages en fonction des dates entrées par l'utilisateur. Pour un champ vide, le message d'alerte est le même que d'habitude. Il y a six messages qui peuvent apparaître :
