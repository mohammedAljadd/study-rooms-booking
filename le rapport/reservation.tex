...
\item    \textcolor{green}{ GMAIL et PHP} :
 ...
 \hspace*{-1.05in}
   ...
   \vspace{0.6cm}  
	\danger Comme vous le voyez sur l'image même si j'entre le nom d'utilisateur et le mot de passe correct le serveur n'arrive pas à me laisser entrer dans ce dossier.  
  \end{enumerate}
\end{enumerate}
